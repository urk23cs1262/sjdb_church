        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center">
          ...
          <div className="relative flex-1 overflow-hidden h-6">
            ...
            >
              ...
              >
                {/* Saint Thumbnail inside ticker */}
                {/* {activeImage && (
                  <img
                    src={activeImage}
                    alt={displayName}
                    onError={() => setImgError(true)}
                    className="w-5 h-5 rounded-full object-cover object-top border border-amber-300/60 inline-block"
                  />
                )} */}
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                            <div>
                              ...
                              <p className="text-xl sm:text-2xl font-bold text-church-gold">
                                {saintOfDay.feastDay || new Date().toLocaleDateString(isTamil ? 'ta-IN' : 'en-GB', {
                                  weekday: 'long',
                                  day: 'numeric',
                                  month: 'long',
                                  year: 'numeric'
                            ...
                            {/* <span className="text-[10px] bg-gray-100 text-gray-600 font-bold px-2.5 py-1 rounded-full uppercase tracking-wider">
                              {saintOfDay.source || "Vatican News"}
                            </span> */}
                          </div>
