 ...
 * Language-independent category IDs with English and Tamil translations.
 */

const CHURCH_MASS_INTENTION_CATEGORIES = [
  {
    id: 'thanksgiving',
...
function getIntentionCategoryLabel(categoryId, lang = 'en') {
